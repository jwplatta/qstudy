...
Outputs written to examples/out/.

Usage:
    uv run python examples/multi-sleeve-us-equities-stat-arb.py
"""
...
def filter_residual_dispersion_high_20_q75(signal, **cache):
    ...
    # Factor-model residuals can be sparse on the calendar index under the
    # membership-aware universe. Build the regime on valid observations only,
    # then align the resulting boolean series back to the full signal calendar.
